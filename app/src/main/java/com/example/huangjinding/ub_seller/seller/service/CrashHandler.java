...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private String CRASH_TAG = this.getClass().getSimpleName();
...
//        addCustomInfo();
    ...
    public void collectDeviceInfo(Context ctx) {
        ...
        try {
            ...
            Log.e(CRASH_TAG, "an error occured when collect package info", e);
        }
        //获取所有系统信息
        ...
        for (Field field : fields) {
            try {
                ...
                Log.e(CRASH_TAG, "an error occured when collect crash info", e);
            }
        }
    }
